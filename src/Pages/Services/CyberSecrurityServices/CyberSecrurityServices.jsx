...
import './CyberSecrurityServices.scss';
...
export default function CyberSecrurityServices() {
                    ...
                    <div className="hero-content">
                        <div className="hero-text">
                            ...
                            <p className="heading_subtitle">
                                Protect your business from evolving cyber threats with comprehensive cybersecurity services. We help organizations secure applications, networks, cloud infrastructure, and sensitive data through proactive risk assessments, threat detection, compliance, and continuous security monitoring.
                            </p>
                            <ul class="bnrlst mb-4">
                                <li>Threat Detection & Risk Assessment</li>
