                    ...
                    <div className="services-section">
                        <div className="services-left">
                            ...
                            <h2 className="heading_title" style={{ color: 'white' }}>
                                <span>Testing & Quality</span> Assurance Services Built for Reliable Software
                            </h2>
                            <p className="heading_subtitle">
                                Deliver high-quality software with comprehensive testing and QA services. We ensure your applications are secure, reliable, performant, and ready for production through manual and automated testing.
                            </p>
