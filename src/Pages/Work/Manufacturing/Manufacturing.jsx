        ...
        <div className="manufacturing">
            ...
            <section class="services-hero">
                ...
                <div class="services-hero__inner container">
                    ...
                    <span class="hero_badge">Manufacturing</span>

                    <h1 class="heading_title services-hero__title">
                        <span>Engineering Intelligence</span> <br />into Every Production Line
                    </h1>

                    <p class="heading_subtitle services-hero__subtitle">
                        We create next-generation manufacturing software that connects machines, data, people, and processes—enabling real-time visibility, intelligent automation, predictive insights, and smarter production decisions.
                    </p>
                        ...
                        >
                            <div>
                                ...
                                <h2 className="heading_title">
                                    Manufacturing <span>Solutions</span>
                                </h2>
                                <p className='our-work__desc heading_subtitle'>Smart Digital Solutions for Connected & Intelligent Manufacturing</p>
                            </div>
